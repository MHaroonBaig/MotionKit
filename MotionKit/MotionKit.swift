...
@objc(MotionKit) open class MotionKit :NSObject{
    ...
    */
    open func getAccelerometerValues (_ interval: TimeInterval = 0.1,
    ...
    */
    open func getGyroValues (_ interval: TimeInterval = 0.1,
                             values: ((_ x: Double, _ y: Double, _ z:Double) -> ())? ) {
    ...
    */
    ...
    open func getMagnetometerValues (_ interval: TimeInterval = 0.1,
                                     values: ((_ x: Double, _ y:Double, _ z:Double) -> ())? ){
    ...
    */
    open func getAccelerationFromDeviceMotion (_ interval: TimeInterval = 0.1,
                                               values: ((_ x:Double, _ y:Double, _ z:Double) -> ())? ) {
    ...
    *   method.
    */
    open func getAttitudeFromDeviceMotion (_ interval: TimeInterval = 0.1,
    ...
    *   method.
    */
    open func getRotationRateFromDeviceMotion (_ interval: TimeInterval = 0.1,
                                               values: ((_ x:Double, _ y:Double, _ z:Double) -> ())? ) {
